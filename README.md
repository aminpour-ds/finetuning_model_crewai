...
An intelligent medical consultation system powered by [crewAI](https://crewai.com) and fine-tuned phi-3 models running locally via Ollama. This system simulates a clinical workflow with 3 specialized AI agents that conduct patient interviews, process clinical data, generate assessments, and maintain persistent medical records.
...
- **Medical History Gathering**: focused history-taking based on patient status
...
6. **Data Persistence**: Saves consultation records to database
...
- Visit [GitHub repository](https://github.com/joaomdmoura/crewai)
